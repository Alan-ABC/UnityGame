...
namespace UnityGameToolkit
{
    ...
    public class ResourceManager : SingleManagerBase
    {
        private string _baseDownloadingURL = ""; 
        private string[] _allManifest = null;
        ...
        private Dictionary<string, List<LoadAssetRequest>> _loadRequests = new Dictionary<string, List<LoadAssetRequest>>();
        ...
        {
            _baseDownloadingURL = PathUtil.GetRelativePath();
        ...
        {
            if (abName.Equals(AppConf.AssetDir))
            {
                return abName;
            }
            ...
            if (!abName.EndsWith(AppConf.ExtName))
            {
                abName += AppConf.ExtName;
            }
        ...
        /// 载入素材
        /// </summary>
        void LoadAsset<T>(string abName, string[] assetNames, Action<UnityEngine.Object[]> action = null) where T : UnityEngine.Object
        {
